...
{
    const char* pszTimestamp = "CNN 27/Nov/2021 Omicron coronavirus variant";
    const CScript genesisOutputScript = CScript() << ParseHex("192484710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1638073330, 2000895216, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb77c1e1bdf59af2b6c826e2a0e36fd0981d2bcf18143925243729c3616c3a4a4"));
        assert(genesis.hashMerkleRoot == uint256S("0x90b932ffd895fdc665dbeeffe1b08039a01a2e6a12aca99510bf6fae7a11448f"));
        ...
        vSeeds.emplace_back("143.110.158.84");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.bitcoinmetatools.com");
        //vSeeds.emplace_back("dnsseed.bitcoinmetapool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0xb77c1e1bdf59af2b6c826e2a0e36fd0981d2bcf18143925243729c3616c3a4a4")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1638073330, 2064000, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xdeafbb470ab08bbe6a5f8471795b3850c29b7576403a156c48f989f3caf5ea21"));
        assert(genesis.hashMerkleRoot == uint256S("0x90b932ffd895fdc665dbeeffe1b08039a01a2e6a12aca99510bf6fae7a11448f"));
        ...
        vSeeds.emplace_back("143.110.158.84");
        //vSeeds.emplace_back("seed-b.bitcoinmeta.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("0xdeafbb470ab08bbe6a5f8471795b3850c29b7576403a156c48f989f3caf5ea21")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1638073330, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3d7f1b0aa432ea8193732e259bd03e52bc7d8512249266c32b737177915a4bc4"));
        assert(genesis.hashMerkleRoot == uint256S("0x90b932ffd895fdc665dbeeffe1b08039a01a2e6a12aca99510bf6fae7a11448f"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x3d7f1b0aa432ea8193732e259bd03e52bc7d8512249266c32b737177915a4bc4")},
            }
        };
