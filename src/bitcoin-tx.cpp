...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinmeta-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinmeta-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinmeta transaction\n" +
            "or:     bitcoinmeta-tx [options] -create [commands]   Create hex-encoded bitcoinmeta transaction\n" +
            "\n";
