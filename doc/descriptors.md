# Support for Output Descriptors in BitcoinMeta Core

Since BitcoinMeta Core v0.17, there is support for Output Descriptors. This is a
...
on BitcoinMeta's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing BitcoinMeta Core wallets, a convenience function `combo` is
