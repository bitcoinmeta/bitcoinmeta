BitcoinMeta Core version *0.15.1* is now available from:

  <https://download.bitcoinmeta.org/bitcoinmeta-0.15.1/>
...
A number of changes to the way BitcoinMeta Core deals with peer connections and invalid blocks
