...
"""Verify that starting bitcoinmeta with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinmeta with -h for help text")
        ...
        self.log.info("Start bitcoinmeta with -version for version information")
        ...
        self.log.info("Start bitcoinmetad with -fakearg to make sure it does not start")
